...
/bin/df -h  || :
/usr/bin/free -m || :
/bin/ls -la /srv/tftpboot/repos/ /srv/tftpboot/repos/Cloud/ /srv/tftpboot/suse-*/install/ || :
...
#TODO check_repo_content SLE12-Cloud-Compute
...
if [ -n "$CROWBAR_FROM_GIT" ]; then
    ...
    # missing dependencies. (This is not an issue for package based installs,
    # since the rake task are part of the -devel subpackage which is not
